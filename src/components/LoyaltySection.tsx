...
export default function LoyaltySection() {
  ...
  const tiers = [
    {
      name: t('loyalty.bronze'),
      icon: Star,
      points: '0-499',
      benefits: ['5% off all orders', 'Birthday surprise', 'Early sale access'],
    ...
    },
    {
      ...
      icon: Gift,
      points: '500-1499',
      benefits: ['10% off all orders', 'Free shipping', 'Exclusive products', 'Priority support'],
    ...
    },
    {
      ...
      icon: Crown,
      points: '1500+',
      benefits: ['15% off all orders', 'VIP events', 'Personal stylist', 'Free returns', 'Double points days'],
