  ...
  "rounded-xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        product: "shadow-card hover:shadow-lg hover:scale-[1.02] cursor-pointer overflow-hidden",
        category: "shadow-soft hover:shadow-glow overflow-hidden group cursor-pointer",
        glass: "bg-background/80 backdrop-blur-sm border-border/50",
        festive: "border-primary/20 shadow-soft bg-gradient-to-br from-secondary to-background",
      },
    },
    defaultVariants: {
      variant: "default",
